...
// 内部组件：为每个 projectId 创建独立的 runtime
function ChatRuntimeInner({ 
  ...
  return (
    <ChatRuntimeContext.Provider value={{ projectId, hasMoreMessages: hasMore, loadingMore, loadMoreMessages }}>
...
export function ChatRuntimeProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ChatRuntimeContext.Provider value={{ projectId, hasMoreMessages: false, loadingMore: false, loadMoreMessages: () => {} }}>
      <ChatRuntimeInner key={projectId} projectId={projectId}>
        {children}
      </ChatRuntimeInner>
    </ChatRuntimeContext.Provider>
  )
